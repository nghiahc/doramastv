...
if (!function_exists('is_current_host')) {
     ...
     * @return bool
     */
    function is_current_host($url)
    {
        if (request()->server('HTTP_HOST') === $url) {
            return true;
        }
...
if (!function_exists('getCategoriesForNavigation')) {
    ...
    {
        return app()->make(\App\Helpers\General\Category::class)->getCategoriesForNavigation();
    }
}

if (!function_exists('getNewEpisodesForSidebar')) {

    /**
     * @return array
     */
    function getNewEpisodesForSidebar()
    {
        return app()->make(\App\Helpers\General\Movie::class)->getNewEpisodesForSidebar();
    }
}

if (!function_exists('getNewMoviesForSidebar')) {

    /**
     * @return array
     */
    function getNewMoviesForSidebar()
    {
